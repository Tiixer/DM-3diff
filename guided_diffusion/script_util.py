...
def model_and_diffusion_defaults():
    ...
    res = dict(
        ...
        enc_num_filters = [32, 64, 128, 256],
        dec_num_filters = [256, 256, 512, 512],
        latent_dim = 1,
        # no_convs_per_block = 3,
        # initializers = {'w':'he_normal', 'b':'normal'},
        input_channels_dist = 3
    )
...
def create_model_and_diffusion(
    ...
    distribution = AxisAlignedConvGaussian(
                                    input_channels_dist,
                                    enc_num_filters,
                                    dec_num_filters,
                                    latent_dim,
    ...
    return model, diffusion, distribution
